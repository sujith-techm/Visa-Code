		...
		<table width="100%" height="100%" border="0">
			<tr>
				...
				<td width="*" height="100%" align="center" valign="top"><br><br>
					...
					<form name="f1" action="../delExecutive" onSubmit="return Validate();" method="post">
              <font color="#001967">Select Executive To Delete : </font>
              <%  
							Database con=new Database();
							ResultSet rs=con.getResultSet("select ExeID,Name from Executive");
						%>
              <select name="ExeID">
							<option value="">..Select..</option>
							<% 
								while(rs.next()){
								String ID=rs.getString("ExeID");
